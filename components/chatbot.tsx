...
import { Send, Bot, User, X, MessageCircle, Brain } from "lucide-react"
...
export function ChatBot({ paper, onClose }: ChatBotProps) {
  ...
  const generateBotResponse = (question: string): string => {
    ...
    if (lowerQuestion.includes("main finding") || lowerQuestion.includes("key finding")) {
    ...
    } else if (lowerQuestion.includes("methodology") || lowerQuestion.includes("method")) {
    ...
    } else if (lowerQuestion.includes("application") || lowerQuestion.includes("practical")) {
    ...
    } else if (lowerQuestion.includes("relate") || lowerQuestion.includes("other research")) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 flex flex-col" style={{ backgroundColor: theme.background }}>
        <DialogHeader
            ...
            <DialogTitle className="flex items-center gap-3 text-xl">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <MessageCircle className="h-4 w-4" style={{ color: theme.secondary }} />
        ...
        >
          <p className="text-sm mb-3" style={{ color: `${theme.foreground}70` }}>
            Suggested questions:
          </p>
              ...
              >
                  ...
                  style={{
                    backgroundColor:
                      message.type === "user"
                        ...
                        : `${theme.muted}50`,
                    borderColor: message.type === "user" ? "transparent" : `${theme.primary}20`,
                ...
                >
                  ...
                  <p
                    ...
                    style={{
                      color: message.type === "user" ? "rgba(255, 255, 255, 0.7)" : `${theme.foreground}70`,
                    }}
                  >
              ...
              <div className="flex gap-3 justify-start animate-fade-in">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm" style={{ color: `${theme.foreground}70` }}>
                      AI is thinking...
                    </span>
                  </div>
                </Card>
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              style={{
                ...
                hover: {
                  background: `linear-gradient(to right, ${theme.secondary}90, ${theme.primary}90)`,
                },
              }}
            >
